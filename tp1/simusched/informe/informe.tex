...
Para la primera prueba lanzamos una tarea igual a la del $ejercicio2$ con la diferencia que lanza $taskRolando$ una vez mas al final, de esta manera tendremos 4 procesos, los cuales corren en 2 cpu. \\

      \begin{figure}[H]
        \includegraphics[scale=0.5]{Ej8RR2Prueba2}
        \caption{Simulacion schedRR2 para TareaRRTests2} 
      \end{figure}
